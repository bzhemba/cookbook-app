(function (b) {
    ...
    function a(ac, ae, G) {
        var ao, av, S, A, O, L, I, E, o, ad, ah, C, N, aw = new Array(), K = new Array(), F, ab, Z, Y, W, U, ay, ag, J,
            s, c, aq, am, ax, az, T, al, ak, R, aj, ai, m, D, B, af, y, e, d, l, X, q, v, r, an, w, k, u, P, n, au, t,
            g, ap = '<div class="b-page-empty" title="" rel=""></div>',
        ...
        b.extend(ao, {
            next: function () {
                ...
                if (i > av.curr && i < av.pTotal && i >= 0 && !ad) {
                    ...
                    }, av.speedH, av.easeIn).animate({left: 0, width: av.pWidth, paddingLeft: 0}, av.speedH);
                    ...
                    if (i < av.curr && i < av.pTotal && i >= 0 && !ad) {
                        ...
                        ab.animate({
                            left: av.pWidthH,
                            width: av.pWidthH
                        }, av.speedH, av.easeIn).animate({left: av.pWidth, width: av.pWidth}, av.speedH, av.easeOut);
